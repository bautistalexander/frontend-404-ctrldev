    ...
    return (
        <div className="pt-[100px] flex flex-col lg:flex-row ">
            <div className="relative flex flex-col justify-between lg:w-2/3 p-10 gap-10">
                ...
                <h1 className={`text-6xl lg:text-8xl font-nosifer text-shadow-colorShadow0 ${color === 1 ? "text-color1" : color === 2 ? "text-color2" : "text-color3"}`}>Historias y Leyendas de Terror</h1>
