...
export const CategoriasMenu: React.FC<Color> = ({ color }) => {
  return (
    <div className={`font-special flex flex-wrap flex-row justify-around gap-6 border-2 rounded-xl md:rounded-3xl mx-5 ${color === 1 ? "border-color1" : color === 2 ? "border-color2" : "border-color3"}`}>
